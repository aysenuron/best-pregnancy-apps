...
export const metadata: Metadata = {
  ...
  description: 'Independent comparison of the top 5 pregnancy tracking apps. Expert evaluation based on medical accuracy, privacy, features, and user experience.',
  keywords: ['pregnancy apps', 'pregnancy tracker', 'best pregnancy app', 'pregnancy guide', 'contraction timer'],
